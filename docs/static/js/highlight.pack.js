...
}();"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("julia-repl",(()=>{"use strict";return a=>({
name:"Julia REPL",contains:[{className:"meta",begin:/^julia>/,relevance:10,
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
